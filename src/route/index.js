  ...
  res.render('task31', {
    ...
    city: {
      ...
      cards: [
        ...
        {
          picture: {
            src: 'https://picsum.photos/400/200/?blur-1',
            alt: 'Paris',
          },
          title: 'Paris',
          description:
        ...
        {
          picture: {
            src: 'https://picsum.photos/400/200/?blur-2',
            alt: 'Tokyo',
          },
          title: 'Tokyo',
          description:
        ...
        {
          picture: {
            src: 'https://picsum.photos/400/200/?blur-3',
            alt: 'Sydney',
          },
          title: 'Sydney',
          description:
...
router.get('/shophome', function (req, res) {
  ...
  res.render('shophome', {
    ...
    goodsBlock: {
      ...
      cards: [
        {
          image: 'https://picsum.photos/400/200/?blur-1',
          title: 'iPhone 13',
          description:
        ...
        {
          image: 'https://picsum.photos/400/200/?blur-2',
          title: 'MacBook Pro',
          description:
        ...
        {
          image: 'https://picsum.photos/400/200/?blur-3',
          title: 'AirPods Pro',
          description:
        ...
        {
          image: 'https://picsum.photos/400/200/?blur-4',
...
router.get('/shopcart', function (req, res) {
  ...
  res.render('shopcart', {
    ...
    goodsBlock: [
      ...
      {
        image: 'https://picsum.photos/110/110/?blur-1',
      ...
      {
        image: 'https://picsum.photos/110/110/?blur-2',
      ...
      {
        image: 'https://picsum.photos/110/110/?blur-3',
    ...
    reviewList: [
      {
        ...
        reviewBody: {
          ...
          images: [
            ...
            'https://picsum.photos/110/100/?blur-1',
            'https://picsum.photos/110/100/?blur-2',
          ],
          coments: [
            {
              userName: 'Користувач',
...
router.get('/shopcatalog', function (req, res) {
  ...
  res.render('shopcatalog', {
    ...
    goodsList: [
      ...
      {
        img: 'https://picsum.photos/400/200/?blur-1',
        isFree: true,
        name: 'Ноут',
        review: {
          amount: 13,
      ...
      {
        img: 'https://picsum.photos/400/200/?blur-2',
        isHot: true,
        isFree: true,
        name: 'Ноут',
        review: {
      ...
      {
        img: 'https://picsum.photos/400/200/?blur-3',
        isHot: true,
        isFast: true,
        name: 'Ноут',
        review: {
